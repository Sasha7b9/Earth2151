...
SET INTERFACE_NAME="My grecccat interface"
SET INTERFACE_ID=JS5
...
%TOOLS_PATH%\Pic2Tex.exe -key -mipmap1 5 1 DIAL64.bmp
%TOOLS_PATH%\Pic2Tex.exe -key -mipmap1 #DIALT32.tga

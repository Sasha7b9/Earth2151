...
bool Model2150::ReadMeshFile(pchar _name)
{
    ...
    {
        LOG_ERROR("Can't open file %s", name_file.c_str());
    ...
    {
        LOG_ERROR("Not correct header for file \"%s\"", _name);
...
{
    texture_file_name = reader.ReadString(4);
}
...
void Model2150::SaveToFileMDL()
{
    ...
    {
        LOG_ERROR("%s is not mesh file", file_name.c_str());
    }
}

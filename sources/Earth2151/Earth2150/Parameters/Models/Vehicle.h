...
struct Vehicle : public EquipableEntity
{
        ...
        EquipableEntity(name, researhces, type, reader)
    {
        ...
        engine_smoke_ID = reader.ReadString(4);
        reader.ReadUInt();
        dist_ID = reader.ReadString(4);
        reader.ReadUInt();
        billow_ID = reader.ReadString(4);
        reader.ReadUInt();
        stand_billow_ID = reader.ReadString(4);
        reader.ReadUInt();
        track_ID = reader.ReadString(4);
        reader.ReadUInt();
    }

...
#pragma once
#include "Game/Parameters/Models/Abstracts/TypedEntity.h"
...
struct InteractableEntity : public TypedEntity
{
    ...
    {
        mesh_name = reader.ReadString();
        shadow_type = reader.ReadInt();
        view_params_index = reader.ReadInt();
        cost = reader.ReadInt();
        time_build = reader.ReadInt();
        sound_pack_ID = reader.ReadString();
        reader.ReadUInt();
        smoke_ID = reader.ReadString();
        reader.ReadUInt();
        kill_explosion_ID = reader.ReadString();
        reader.ReadUInt();
        distributed_ID = reader.ReadString();
        reader.ReadUInt();
    }

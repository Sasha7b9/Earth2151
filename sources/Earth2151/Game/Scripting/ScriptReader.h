...
public:
    ...
    OperatorNull *ReadOperatorNull(SObject *, State *);

    OperatorIf *ReadOperatorIf(SObject *, State *);

    OperatorReturn *ReadOperatorReturn(SObject *, State *);

    OperatorAssign *ReadOperatorAssign(SObject *, State *, const String<> &);

    OperatorFunction *ReadOperatorFunction(SObject *, State *, pchar name);
